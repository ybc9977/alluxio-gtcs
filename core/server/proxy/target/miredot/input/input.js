...
com.qmino.miredot.restApiSource = {
	"projectName":"Alluxio Core - Server - Proxy",
	...
	"singlePage":false,
	"hideLogoOnTop":false,
	"dateOfGeneration":"2018-09-18 20:39:52",
	"validLicense":true,
	"licenseErrorMessage":[
	...
	"licenseHash":"-2791602485766670482",
...
com.qmino.miredot.restApiSource.interfaces = [
	...
	},
	{
		...
		"url":"/s3/{bucket}",
		"http":"GET",
		"title":"gets a bucket and lists all the objects in it",
		"tags":[
		...
		"permitAll":false,
		"output":{
			"typeValue":com.qmino.miredot.restApiSource.tos["alluxio_proxy_s3_ListBucketResult_out"],
			"comment":"the response object",
		},
		"statusCodes":[
			{
			...
			"QUERY":[
				{
					...
					"comment":"the optional continuation token param",
					"jaxrs":"QUERY",
				},
				{
					"name":"max-keys",
					...
					"comment":"the optional max keys param",
					"jaxrs":"QUERY",
				},
				{
					"name":"prefix",
					...
					"comment":"the optional prefix param",
					"jaxrs":"QUERY",
				},
			],
			"BODY":[
			...
			"QUERY":[
				{
					...
					"comment":"the upload ID which identifies the incomplete multipart upload to be aborted",
					"jaxrs":"QUERY",
				},
			],
			"BODY":[
	...
	},
	{
		...
		"url":"/s3/{bucket}/{object:.+}",
		"http":"HEAD",
		"title":"retrieves an object's metadata",
		"tags":[
	...
	},
	{
		...
		"url":"/s3/{bucket}/{object:.+}",
		"http":"POST",
		"title":"initiates or completes a multipart upload based on query parameters",
		"tags":[
			...
			"QUERY":[
				{
					...
					"comment":"the query parameter specifying that this request is to initiate a multipart upload instead of uploading an object through HTTP multipart forms",
					"jaxrs":"QUERY",
				},
				{
					"name":"uploadId",
					...
					"comment":"the ID of the multipart upload to be completed",
					"jaxrs":"QUERY",
				},
			],
			"BODY":[
	...
	},
	{
		...
		"url":"/s3/{bucket}/{object:.+}",
		"http":"PUT",
		"title":"uploads an object or part of an object in multipart upload",
		"tags":[
			...
			"QUERY":[
				{
					...
					"comment":"the identification of the part of the object in multipart upload, otherwise null",
					"jaxrs":"QUERY",
				},
				{
					"name":"uploadId",
					...
					"comment":"the upload ID of the multipart upload, otherwise null",
					"jaxrs":"QUERY",
				},
			],
			"BODY":[
			...
			"HEADER":[
				{
					...
					"comment":"the optional Base64 encoded 128-bit MD5 digest of the object",
					"jaxrs":"HEADER",
				},
			],
			"COOKIE":[
	...
	},
	{
		...
		"url":"/proxy/info",
		"http":"GET",
		"title":"get the Alluxio proxy information",
		"tags":[
		...
		"permitAll":false,
		"output":{
			"typeValue":com.qmino.miredot.restApiSource.tos["alluxio_wire_AlluxioProxyInfo_out"],
			"comment":"the response object",
		},
		"statusCodes":[
			{
	...
	},
	{
		...
		"url":"/s3/{bucket}/{object:.+}",
		"http":"GET",
		"title":"downloads an object or list parts of the object in multipart upload",
		"tags":[
			...
			"QUERY":[
				{
					...
					"comment":"the ID of the multipart upload, if not null, listing parts of the object",
					"jaxrs":"QUERY",
				},
			],
			"BODY":[
