...
public class AccessTResponse implements org.apache.thrift.TBase<AccessTResponse, AccessTResponse._Fields>, java.io.Serializable, Cloneable, Comparable<AccessTResponse> {
  ...
  static {
    schemes.put(StandardScheme.class, new AccessTResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AccessTResponseTupleSchemeFactory());
  }

  public Map<String,Integer> access; // required
  ...
  public AccessTResponse deepCopy() {
    return new AccessTResponse(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AccessTResponse)
      return this.equals((AccessTResponse)that);
    return false;
  }

  public boolean equals(AccessTResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AccessTResponse other) {
  ...
  private static class AccessTResponseStandardSchemeFactory implements SchemeFactory {
    public AccessTResponseStandardScheme getScheme() {
      return new AccessTResponseStandardScheme();
    }
  }

  private static class AccessTResponseStandardScheme extends StandardScheme<AccessTResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AccessTResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AccessTResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AccessTResponseTupleSchemeFactory implements SchemeFactory {
    public AccessTResponseTupleScheme getScheme() {
      return new AccessTResponseTupleScheme();
    }
  }

  private static class AccessTResponseTupleScheme extends TupleScheme<AccessTResponse> {
