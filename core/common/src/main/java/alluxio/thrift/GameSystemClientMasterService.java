...
public class GameSystemClientMasterService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
    ...
    public CheckCacheChangeTResponse checkCacheChange(Map<Long,Boolean> fileList, CheckCacheChangeTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;

  }

  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {

    public void checkCacheChange(Map<Long,Boolean> fileList, CheckCacheChangeTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public CheckCacheChangeTResponse checkCacheChange(Map<Long,Boolean> fileList, CheckCacheChangeTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_checkCacheChange(fileList, options);
      return recv_checkCacheChange();
    }

    public void send_checkCacheChange(Map<Long,Boolean> fileList, CheckCacheChangeTOptions options) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void checkCacheChange(Map<Long,Boolean> fileList, CheckCacheChangeTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      checkCacheChange_call method_call = new checkCacheChange_call(fileList, options, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class checkCacheChange_call extends org.apache.thrift.async.TAsyncMethodCall {
      private Map<Long,Boolean> fileList;
      private CheckCacheChangeTOptions options;
      public checkCacheChange_call(Map<Long,Boolean> fileList, CheckCacheChangeTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class checkCacheChange<I extends Iface> extends org.apache.thrift.ProcessFunction<I, checkCacheChange_args> {
      ...
      public checkCacheChange_result getResult(I iface, checkCacheChange_args args) throws org.apache.thrift.TException {
        checkCacheChange_result result = new checkCacheChange_result();
        try {
          result.success = iface.checkCacheChange(args.fileList, args.options);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class checkCacheChange<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, checkCacheChange_args, CheckCacheChangeTResponse> {
      ...
      public void start(I iface, checkCacheChange_args args, org.apache.thrift.async.AsyncMethodCallback<CheckCacheChangeTResponse> resultHandler) throws TException {
        iface.checkCacheChange(args.fileList, args.options,resultHandler);
      }
    }
  ...
  public static class checkCacheChange_args implements org.apache.thrift.TBase<checkCacheChange_args, checkCacheChange_args._Fields>, java.io.Serializable, Cloneable, Comparable<checkCacheChange_args>   {
    ...
    public Map<Long,Boolean> fileList; // required
    public CheckCacheChangeTOptions options; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.OPTIONS, new org.apache.thrift.meta_data.FieldMetaData("options", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, CheckCacheChangeTOptions.class)));
    ...
    public checkCacheChange_args(
      Map<Long,Boolean> fileList,
      CheckCacheChangeTOptions options)
    {
      this();
      this.fileList = fileList;
      this.options = options;
    ...
    public checkCacheChange_args(checkCacheChange_args other) {
      if (other.isSetFileList()) {
        Map<Long,Boolean> __this__fileList = new HashMap<Long,Boolean>(other.fileList);
        this.fileList = __this__fileList;
      }
      if (other.isSetOptions()) {
        this.options = new CheckCacheChangeTOptions(other.options);
      }
    }
    ...
    public void putToFileList(long key, boolean val) {
      if (this.fileList == null) {
        this.fileList = new HashMap<Long,Boolean>();
      }
      this.fileList.put(key, val);
    }

    public Map<Long,Boolean> getFileList() {
      return this.fileList;
    }

    public checkCacheChange_args setFileList(Map<Long,Boolean> fileList) {
      this.fileList = fileList;
      return this;
    }
    ...
    public CheckCacheChangeTOptions getOptions() {
      return this.options;
    }

    public checkCacheChange_args setOptions(CheckCacheChangeTOptions options) {
      this.options = options;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case FILE_LIST:
        if (value == null) {
          ...
          setFileList((Map<Long,Boolean>)value);
        }
        break;
      ...
      case OPTIONS:
        if (value == null) {
          ...
          setOptions((CheckCacheChangeTOptions)value);
        }
        break;
    ...
    private static class checkCacheChange_argsStandardScheme extends StandardScheme<checkCacheChange_args> {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.fileList = new HashMap<Long,Boolean>(2*_map8.size);
                  long _key9;
                  boolean _val10;
            ...
            case 2: // OPTIONS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.options = new CheckCacheChangeTOptions();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkCacheChange_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.fileList != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.BOOL, struct.fileList.size()));
            for (Map.Entry<Long, Boolean> _iter12 : struct.fileList.entrySet())
            {
    ...
    private static class checkCacheChange_argsTupleScheme extends TupleScheme<checkCacheChange_args> {
        ...
        if (struct.isSetFileList()) {
          {
            ...
            for (Map.Entry<Long, Boolean> _iter13 : struct.fileList.entrySet())
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, checkCacheChange_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TMap _map14 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
            struct.fileList = new HashMap<Long,Boolean>(2*_map14.size);
            long _key15;
            boolean _val16;
