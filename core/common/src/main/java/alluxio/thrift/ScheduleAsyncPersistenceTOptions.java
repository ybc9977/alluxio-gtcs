...
public class ScheduleAsyncPersistenceTOptions implements org.apache.thrift.TBase<ScheduleAsyncPersistenceTOptions, ScheduleAsyncPersistenceTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<ScheduleAsyncPersistenceTOptions> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ScheduleAsyncPersistenceTOptions");
  ...
  static {
    schemes.put(StandardScheme.class, new ScheduleAsyncPersistenceTOptionsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ScheduleAsyncPersistenceTOptionsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ScheduleAsyncPersistenceTOptions.class, metaDataMap);
  }
   ...
   */
  public ScheduleAsyncPersistenceTOptions(ScheduleAsyncPersistenceTOptions other) {
    if (other.isSetCommonOptions()) {
      this.commonOptions = new FileSystemMasterCommonTOptions(other.commonOptions);
    }
  }

  public ScheduleAsyncPersistenceTOptions deepCopy() {
  ...
  public ScheduleAsyncPersistenceTOptions setCommonOptions(FileSystemMasterCommonTOptions commonOptions) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ScheduleAsyncPersistenceTOptions)
      return this.equals((ScheduleAsyncPersistenceTOptions)that);
    return false;
  }

  public boolean equals(ScheduleAsyncPersistenceTOptions that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ScheduleAsyncPersistenceTOptions other) {
  ...
  private static class ScheduleAsyncPersistenceTOptionsStandardSchemeFactory implements SchemeFactory {
    public ScheduleAsyncPersistenceTOptionsStandardScheme getScheme() {
      return new ScheduleAsyncPersistenceTOptionsStandardScheme();
    }
  }

  private static class ScheduleAsyncPersistenceTOptionsStandardScheme extends StandardScheme<ScheduleAsyncPersistenceTOptions> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ScheduleAsyncPersistenceTOptions struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ScheduleAsyncPersistenceTOptions struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ScheduleAsyncPersistenceTOptionsTupleSchemeFactory implements SchemeFactory {
    public ScheduleAsyncPersistenceTOptionsTupleScheme getScheme() {
      return new ScheduleAsyncPersistenceTOptionsTupleScheme();
    }
  }

  private static class ScheduleAsyncPersistenceTOptionsTupleScheme extends TupleScheme<ScheduleAsyncPersistenceTOptions> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ScheduleAsyncPersistenceTOptions struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ScheduleAsyncPersistenceTOptions struct) throws org.apache.thrift.TException {
