...
public class RenameTOptions implements org.apache.thrift.TBase<RenameTOptions, RenameTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<RenameTOptions> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RenameTOptions");
  ...
  static {
    schemes.put(StandardScheme.class, new RenameTOptionsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RenameTOptionsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RenameTOptions.class, metaDataMap);
  }

  public RenameTOptions() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public RenameTOptions(RenameTOptions other) {
    if (other.isSetCommonOptions()) {
      this.commonOptions = new FileSystemMasterCommonTOptions(other.commonOptions);
    }
  }

  public RenameTOptions deepCopy() {
    return new RenameTOptions(this);
  }
  ...
  public RenameTOptions setCommonOptions(FileSystemMasterCommonTOptions commonOptions) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RenameTOptions)
      return this.equals((RenameTOptions)that);
    return false;
  }

  public boolean equals(RenameTOptions that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RenameTOptions other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RenameTOptions(");
    boolean first = true;
  ...
  private static class RenameTOptionsStandardSchemeFactory implements SchemeFactory {
    public RenameTOptionsStandardScheme getScheme() {
      return new RenameTOptionsStandardScheme();
    }
  }

  private static class RenameTOptionsStandardScheme extends StandardScheme<RenameTOptions> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RenameTOptions struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RenameTOptions struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RenameTOptionsTupleSchemeFactory implements SchemeFactory {
    public RenameTOptionsTupleScheme getScheme() {
      return new RenameTOptionsTupleScheme();
    }
  }

  private static class RenameTOptionsTupleScheme extends TupleScheme<RenameTOptions> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RenameTOptions struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RenameTOptions struct) throws org.apache.thrift.TException {
