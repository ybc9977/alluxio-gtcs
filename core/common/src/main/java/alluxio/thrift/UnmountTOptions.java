...
public class UnmountTOptions implements org.apache.thrift.TBase<UnmountTOptions, UnmountTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<UnmountTOptions> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UnmountTOptions");
  ...
  static {
    schemes.put(StandardScheme.class, new UnmountTOptionsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UnmountTOptionsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UnmountTOptions.class, metaDataMap);
  }

  public UnmountTOptions() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public UnmountTOptions(UnmountTOptions other) {
    if (other.isSetCommonOptions()) {
      this.commonOptions = new FileSystemMasterCommonTOptions(other.commonOptions);
    }
  }

  public UnmountTOptions deepCopy() {
    return new UnmountTOptions(this);
  }
  ...
  public UnmountTOptions setCommonOptions(FileSystemMasterCommonTOptions commonOptions) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UnmountTOptions)
      return this.equals((UnmountTOptions)that);
    return false;
  }

  public boolean equals(UnmountTOptions that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(UnmountTOptions other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UnmountTOptions(");
    boolean first = true;
  ...
  private static class UnmountTOptionsStandardSchemeFactory implements SchemeFactory {
    public UnmountTOptionsStandardScheme getScheme() {
      return new UnmountTOptionsStandardScheme();
    }
  }

  private static class UnmountTOptionsStandardScheme extends StandardScheme<UnmountTOptions> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UnmountTOptions struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UnmountTOptions struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class UnmountTOptionsTupleSchemeFactory implements SchemeFactory {
    public UnmountTOptionsTupleScheme getScheme() {
      return new UnmountTOptionsTupleScheme();
    }
  }

  private static class UnmountTOptionsTupleScheme extends TupleScheme<UnmountTOptions> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UnmountTOptions struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UnmountTOptions struct) throws org.apache.thrift.TException {
