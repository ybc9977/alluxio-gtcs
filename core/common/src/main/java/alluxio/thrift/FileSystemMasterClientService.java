...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2018-07-14")
public class FileSystemMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
    ...
    public PassUserIdTResponse passUserId(long userId, PassUserIdTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void passUserId(long userId, PassUserIdTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public PassUserIdTResponse passUserId(long userId, PassUserIdTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_passUserId(userId, options);
      return recv_passUserId();
    }

    public void send_passUserId(long userId, PassUserIdTOptions options) throws org.apache.thrift.TException
    {
      passUserId_args args = new passUserId_args();
      args.setUserId(userId);
      args.setOptions(options);
      sendBase("passUserId", args);
    }

    public PassUserIdTResponse recv_passUserId() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      passUserId_result result = new passUserId_result();
      receiveBase(result, "passUserId");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.e != null) {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "passUserId failed: unknown result");
    }
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void passUserId(long userId, PassUserIdTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      passUserId_call method_call = new passUserId_call(userId, options, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class passUserId_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long userId;
      private PassUserIdTOptions options;
      public passUserId_call(long userId, PassUserIdTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.options = options;
      }
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("passUserId", org.apache.thrift.protocol.TMessageType.CALL, 0));
        passUserId_args args = new passUserId_args();
        args.setUserId(userId);
        args.setOptions(options);
        args.write(prot);
      ...
      public PassUserIdTResponse getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_passUserId();
      }
    }
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("passUserId", new passUserId());
    ...
    public static class passUserId<I extends Iface> extends org.apache.thrift.ProcessFunction<I, passUserId_args> {
      public passUserId() {
        super("passUserId");
      }

      public passUserId_args getEmptyArgsInstance() {
        return new passUserId_args();
      }
      ...
      public passUserId_result getResult(I iface, passUserId_args args) throws org.apache.thrift.TException {
        passUserId_result result = new passUserId_result();
        try {
          result.success = iface.passUserId(args.userId, args.options);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class passUserId<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, passUserId_args, PassUserIdTResponse> {
      public passUserId() {
        super("passUserId");
      }
      ...
      public AsyncMethodCallback<PassUserIdTResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<PassUserIdTResponse>() { 
          public void onComplete(PassUserIdTResponse o) {
            passUserId_result result = new passUserId_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, passUserId_args args, org.apache.thrift.async.AsyncMethodCallback<PassUserIdTResponse> resultHandler) throws TException {
        iface.passUserId(args.userId, args.options,resultHandler);
      }
    }
  ...
  public static class checkConsistency_args implements org.apache.thrift.TBase<checkConsistency_args, checkConsistency_args._Fields>, java.io.Serializable, Cloneable, Comparable<checkConsistency_args>   {
     ...
     * the method options
     */
    public CheckConsistencyTOptions options; // required
  ...
  public static class checkConsistency_result implements org.apache.thrift.TBase<checkConsistency_result, checkConsistency_result._Fields>, java.io.Serializable, Cloneable, Comparable<checkConsistency_result>   {
    ...
    public CheckConsistencyTResponse success; // required
  ...
  public static class completeFile_result implements org.apache.thrift.TBase<completeFile_result, completeFile_result._Fields>, java.io.Serializable, Cloneable, Comparable<completeFile_result>   {
    ...
    public CompleteFileTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class createDirectory_args implements org.apache.thrift.TBase<createDirectory_args, createDirectory_args._Fields>, java.io.Serializable, Cloneable, Comparable<createDirectory_args>   {
     ...
     * the method options
     */
    public CreateDirectoryTOptions options; // required
  ...
  public static class createDirectory_result implements org.apache.thrift.TBase<createDirectory_result, createDirectory_result._Fields>, java.io.Serializable, Cloneable, Comparable<createDirectory_result>   {
    ...
    public CreateDirectoryTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class createFile_result implements org.apache.thrift.TBase<createFile_result, createFile_result._Fields>, java.io.Serializable, Cloneable, Comparable<createFile_result>   {
    ...
    public CreateFileTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
...
;
  ...
  public static class getMountTable_result implements org.apache.thrift.TBase<getMountTable_result, getMountTable_result._Fields>, java.io.Serializable, Cloneable, Comparable<getMountTable_result>   {
    ...
    public GetMountTableTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class getNewBlockIdForFile_args implements org.apache.thrift.TBase<getNewBlockIdForFile_args, getNewBlockIdForFile_args._Fields>, java.io.Serializable, Cloneable, Comparable<getNewBlockIdForFile_args>   {
     ...
     * the method options
     */
    public GetNewBlockIdForFileTOptions options; // required
  ...
  public static class getNewBlockIdForFile_result implements org.apache.thrift.TBase<getNewBlockIdForFile_result, getNewBlockIdForFile_result._Fields>, java.io.Serializable, Cloneable, Comparable<getNewBlockIdForFile_result>   {
    ...
    public GetNewBlockIdForFileTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class getStatus_args implements org.apache.thrift.TBase<getStatus_args, getStatus_args._Fields>, java.io.Serializable, Cloneable, Comparable<getStatus_args>   {
     ...
     * the method options
     */
    public GetStatusTOptions options; // required
  ...
  public static class getStatus_result implements org.apache.thrift.TBase<getStatus_result, getStatus_result._Fields>, java.io.Serializable, Cloneable, Comparable<getStatus_result>   {
    ...
    public GetStatusTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class listStatus_args implements org.apache.thrift.TBase<listStatus_args, listStatus_args._Fields>, java.io.Serializable, Cloneable, Comparable<listStatus_args>   {
     ...
     * listStatus options
     */
    public ListStatusTOptions options; // required
  ...
  public static class listStatus_result implements org.apache.thrift.TBase<listStatus_result, listStatus_result._Fields>, java.io.Serializable, Cloneable, Comparable<listStatus_result>   {
    ...
    public ListStatusTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class loadMetadata_args implements org.apache.thrift.TBase<loadMetadata_args, loadMetadata_args._Fields>, java.io.Serializable, Cloneable, Comparable<loadMetadata_args>   {
     ...
     * the method options
     */
    public LoadMetadataTOptions options; // required
  ...
  public static class loadMetadata_result implements org.apache.thrift.TBase<loadMetadata_result, loadMetadata_result._Fields>, java.io.Serializable, Cloneable, Comparable<loadMetadata_result>   {
    ...
    public LoadMetadataTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class mount_args implements org.apache.thrift.TBase<mount_args, mount_args._Fields>, java.io.Serializable, Cloneable, Comparable<mount_args>   {
     ...
     */
    public MountTOptions options; // required
  ...
  public static class mount_result implements org.apache.thrift.TBase<mount_result, mount_result._Fields>, java.io.Serializable, Cloneable, Comparable<mount_result>   {
    ...
    public MountTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class remove_args implements org.apache.thrift.TBase<remove_args, remove_args._Fields>, java.io.Serializable, Cloneable, Comparable<remove_args>   {
     ...
     */
    public DeleteTOptions options; // required
  ...
  public static class remove_result implements org.apache.thrift.TBase<remove_result, remove_result._Fields>, java.io.Serializable, Cloneable, Comparable<remove_result>   {
    ...
    public DeleteTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class passUserId_args implements org.apache.thrift.TBase<passUserId_args, passUserId_args._Fields>, java.io.Serializable, Cloneable, Comparable<passUserId_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("passUserId_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new passUserId_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new passUserId_argsTupleSchemeFactory());
    }

    public long userId; // required
    public PassUserIdTOptions options; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.OPTIONS, new org.apache.thrift.meta_data.FieldMetaData("options", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, PassUserIdTOptions.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(passUserId_args.class, metaDataMap);
    }

    public passUserId_args() {
    }

    public passUserId_args(
      long userId,
      PassUserIdTOptions options)
    {
      this();
      this.userId = userId;
      setUserIdIsSet(true);
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public passUserId_args(passUserId_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.userId = other.userId;
      if (other.isSetOptions()) {
        this.options = new PassUserIdTOptions(other.options);
      }
    }

    public passUserId_args deepCopy() {
      return new passUserId_args(this);
    }
    ...
    public passUserId_args setUserId(long userId) {
      this.userId = userId;
      setUserIdIsSet(true);
      return this;
    }
    ...
    public PassUserIdTOptions getOptions() {
      return this.options;
    }

    public passUserId_args setOptions(PassUserIdTOptions options) {
      this.options = options;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case OPTIONS:
        if (value == null) {
          ...
          setOptions((PassUserIdTOptions)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof passUserId_args)
        return this.equals((passUserId_args)that);
      return false;
    }

    public boolean equals(passUserId_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(passUserId_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("passUserId_args(");
      boolean first = true;
    ...
    private static class passUserId_argsStandardSchemeFactory implements SchemeFactory {
      public passUserId_argsStandardScheme getScheme() {
        return new passUserId_argsStandardScheme();
      }
    }

    private static class passUserId_argsStandardScheme extends StandardScheme<passUserId_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, passUserId_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // OPTIONS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.options = new PassUserIdTOptions();
                struct.options.read(iprot);
                struct.setOptionsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, passUserId_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class passUserId_argsTupleSchemeFactory implements SchemeFactory {
      public passUserId_argsTupleScheme getScheme() {
        return new passUserId_argsTupleScheme();
      }
    }

    private static class passUserId_argsTupleScheme extends TupleScheme<passUserId_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, passUserId_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, passUserId_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.userId = iprot.readI64();
  ...
  public static class passUserId_result implements org.apache.thrift.TBase<passUserId_result, passUserId_result._Fields>, java.io.Serializable, Cloneable, Comparable<passUserId_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("passUserId_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new passUserId_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new passUserId_resultTupleSchemeFactory());
    }

    public PassUserIdTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, PassUserIdTResponse.class)));
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(passUserId_result.class, metaDataMap);
    }

    public passUserId_result() {
    }

    public passUserId_result(
      PassUserIdTResponse success,
      alluxio.thrift.AlluxioTException e)
    {
      this();
      this.success = success;
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public passUserId_result(passUserId_result other) {
      if (other.isSetSuccess()) {
        this.success = new PassUserIdTResponse(other.success);
      }
      if (other.isSetE()) {
        this.e = new alluxio.thrift.AlluxioTException(other.e);
      }
    ...
    public passUserId_result deepCopy() {
      return new passUserId_result(this);
    }
    ...
    public PassUserIdTResponse getSuccess() {
      return this.success;
    }

    public passUserId_result setSuccess(PassUserIdTResponse success) {
      this.success = success;
      return this;
    }
    ...
    public passUserId_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((PassUserIdTResponse)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof passUserId_result)
        return this.equals((passUserId_result)that);
      return false;
    }

    public boolean equals(passUserId_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(passUserId_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("passUserId_result(");
      boolean first = true;
    ...
    private static class passUserId_resultStandardSchemeFactory implements SchemeFactory {
      public passUserId_resultStandardScheme getScheme() {
        return new passUserId_resultStandardScheme();
      }
    }

    private static class passUserId_resultStandardScheme extends StandardScheme<passUserId_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, passUserId_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new PassUserIdTResponse();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, passUserId_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class passUserId_resultTupleSchemeFactory implements SchemeFactory {
      public passUserId_resultTupleScheme getScheme() {
        return new passUserId_resultTupleScheme();
      }
    }

    private static class passUserId_resultTupleScheme extends TupleScheme<passUserId_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, passUserId_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, passUserId_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new PassUserIdTResponse();
  ...
  public static class rename_args implements org.apache.thrift.TBase<rename_args, rename_args._Fields>, java.io.Serializable, Cloneable, Comparable<rename_args>   {
     ...
     * the method options
     */
    public RenameTOptions options; // required
  ...
  public static class rename_result implements org.apache.thrift.TBase<rename_result, rename_result._Fields>, java.io.Serializable, Cloneable, Comparable<rename_result>   {
    ...
    public RenameTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class scheduleAsyncPersistence_args implements org.apache.thrift.TBase<scheduleAsyncPersistence_args, scheduleAsyncPersistence_args._Fields>, java.io.Serializable, Cloneable, Comparable<scheduleAsyncPersistence_args>   {
     ...
     * the method options
     */
    public ScheduleAsyncPersistenceTOptions options; // required
  ...
  public static class scheduleAsyncPersistence_result implements org.apache.thrift.TBase<scheduleAsyncPersistence_result, scheduleAsyncPersistence_result._Fields>, java.io.Serializable, Cloneable, Comparable<scheduleAsyncPersistence_result>   {
    ...
    public ScheduleAsyncPersistenceTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class setAttribute_args implements org.apache.thrift.TBase<setAttribute_args, setAttribute_args._Fields>, java.io.Serializable, Cloneable, Comparable<setAttribute_args>   {
     ...
     * the method options
     */
    public SetAttributeTOptions options; // required
  ...
  public static class setAttribute_result implements org.apache.thrift.TBase<setAttribute_result, setAttribute_result._Fields>, java.io.Serializable, Cloneable, Comparable<setAttribute_result>   {
    ...
    public SetAttributeTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class unmount_args implements org.apache.thrift.TBase<unmount_args, unmount_args._Fields>, java.io.Serializable, Cloneable, Comparable<unmount_args>   {
     ...
     * the method options
     */
    public UnmountTOptions options; // required
  ...
  public static class unmount_result implements org.apache.thrift.TBase<unmount_result, unmount_result._Fields>, java.io.Serializable, Cloneable, Comparable<unmount_result>   {
    ...
    public UnmountTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class updateUfsMode_args implements org.apache.thrift.TBase<updateUfsMode_args, updateUfsMode_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateUfsMode_args>   {
     ...
     * the method options
     */
    public UpdateUfsModeTOptions options; // required
  ...
  public static class updateUfsMode_result implements org.apache.thrift.TBase<updateUfsMode_result, updateUfsMode_result._Fields>, java.io.Serializable, Cloneable, Comparable<updateUfsMode_result>   {
    ...
    public UpdateUfsModeTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
