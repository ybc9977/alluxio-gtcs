...
public class FileSystemMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
    ...
    public RegisterUserTResponse registerUser(String userId, String hostname, alluxio.thrift.ClientNetAddress address, RegisterUserTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void registerUser(String userId, String hostname, alluxio.thrift.ClientNetAddress address, RegisterUserTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public RegisterUserTResponse registerUser(String userId, String hostname, alluxio.thrift.ClientNetAddress address, RegisterUserTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_registerUser(userId, hostname, address, options);
      return recv_registerUser();
    }

    public void send_registerUser(String userId, String hostname, alluxio.thrift.ClientNetAddress address, RegisterUserTOptions options) throws org.apache.thrift.TException
    {
    ...
    public RegisterUserTResponse recv_registerUser() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void registerUser(String userId, String hostname, alluxio.thrift.ClientNetAddress address, RegisterUserTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      registerUser_call method_call = new registerUser_call(userId, hostname, address, options, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class registerUser_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private alluxio.thrift.ClientNetAddress address;
      private RegisterUserTOptions options;
      public registerUser_call(String userId, String hostname, alluxio.thrift.ClientNetAddress address, RegisterUserTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
      ...
      public RegisterUserTResponse getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class registerUser<I extends Iface> extends org.apache.thrift.ProcessFunction<I, registerUser_args> {
      ...
      public registerUser_result getResult(I iface, registerUser_args args) throws org.apache.thrift.TException {
        registerUser_result result = new registerUser_result();
        try {
          result.success = iface.registerUser(args.userId, args.hostname, args.address, args.options);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class registerUser<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, registerUser_args, RegisterUserTResponse> {
      public registerUser() {
        super("registerUser");
      }
      ...
      public AsyncMethodCallback<RegisterUserTResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<RegisterUserTResponse>() { 
          public void onComplete(RegisterUserTResponse o) {
            registerUser_result result = new registerUser_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, registerUser_args args, org.apache.thrift.async.AsyncMethodCallback<RegisterUserTResponse> resultHandler) throws TException {
        iface.registerUser(args.userId, args.hostname, args.address, args.options,resultHandler);
      }
    }
...
;
  ...
  public static class registerUser_args implements org.apache.thrift.TBase<registerUser_args, registerUser_args._Fields>, java.io.Serializable, Cloneable, Comparable<registerUser_args>   {
    ...
    public alluxio.thrift.ClientNetAddress address; // required
    public RegisterUserTOptions options; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.ADDRESS, new org.apache.thrift.meta_data.FieldMetaData("address", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, alluxio.thrift.ClientNetAddress.class)));
      tmpMap.put(_Fields.OPTIONS, new org.apache.thrift.meta_data.FieldMetaData("options", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RegisterUserTOptions.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public registerUser_args(
      String userId,
      String hostname,
      alluxio.thrift.ClientNetAddress address,
      RegisterUserTOptions options)
    {
      this();
      this.userId = userId;
      this.hostname = hostname;
    ...
    public registerUser_args(registerUser_args other) {
      ...
      if (other.isSetAddress()) {
        this.address = new alluxio.thrift.ClientNetAddress(other.address);
      }
      if (other.isSetOptions()) {
        this.options = new RegisterUserTOptions(other.options);
      }
    }
    ...
    public registerUser_args setUserId(String userId) {
      this.userId = userId;
      return this;
    }
    ...
    public registerUser_args setHostname(String hostname) {
      this.hostname = hostname;
      return this;
    }
    ...
    public alluxio.thrift.ClientNetAddress getAddress() {
      return this.address;
    }

    public registerUser_args setAddress(alluxio.thrift.ClientNetAddress address) {
      this.address = address;
      return this;
    }
    ...
    public RegisterUserTOptions getOptions() {
      return this.options;
    }

    public registerUser_args setOptions(RegisterUserTOptions options) {
      this.options = options;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case ADDRESS:
        if (value == null) {
          ...
          setAddress((alluxio.thrift.ClientNetAddress)value);
        }
        break;
      ...
      case OPTIONS:
        if (value == null) {
          ...
          setOptions((RegisterUserTOptions)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, registerUser_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 3: // ADDRESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.address = new alluxio.thrift.ClientNetAddress();
            ...
            case 4: // OPTIONS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.options = new RegisterUserTOptions();
                struct.options.read(iprot);
                struct.setOptionsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
  ...
  public static class registerUser_result implements org.apache.thrift.TBase<registerUser_result, registerUser_result._Fields>, java.io.Serializable, Cloneable, Comparable<registerUser_result>   {
    ...
    public RegisterUserTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RegisterUserTResponse.class)));
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public registerUser_result(registerUser_result other) {
      if (other.isSetSuccess()) {
        this.success = new RegisterUserTResponse(other.success);
      }
      if (other.isSetE()) {
        this.e = new alluxio.thrift.AlluxioTException(other.e);
      }
    ...
    public RegisterUserTResponse getSuccess() {
      return this.success;
    }

    public registerUser_result setSuccess(RegisterUserTResponse success) {
      this.success = success;
      return this;
    }
    ...
    public registerUser_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((RegisterUserTResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, registerUser_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new RegisterUserTResponse();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
