...
public class GameSystemCacheService {
  ...
  public static class checkCacheChange_args implements org.apache.thrift.TBase<checkCacheChange_args, checkCacheChange_args._Fields>, java.io.Serializable, Cloneable, Comparable<checkCacheChange_args>   {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.fileList = new HashMap<String,Boolean>(2*_map28.size);
                  String _key29;
                  boolean _val30;
                  for (int _i31 = 0; _i31 < _map28.size; ++_i31)
                  {
                    _key29 = iprot.readString();
                    _val30 = iprot.readBool();
                    struct.fileList.put(_key29, _val30);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkCacheChange_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.fileList != null) {
          oprot.writeFieldBegin(FILE_LIST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Boolean> _iter32 : struct.fileList.entrySet())
            {
              oprot.writeString(_iter32.getKey());
              oprot.writeBool(_iter32.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
    ...
    private static class checkCacheChange_argsTupleScheme extends TupleScheme<checkCacheChange_args> {
        ...
        if (struct.isSetFileList()) {
          {
            ...
            for (Map.Entry<String, Boolean> _iter33 : struct.fileList.entrySet())
            {
              oprot.writeString(_iter33.getKey());
              oprot.writeBool(_iter33.getValue());
            }
          }
        }
      }
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, checkCacheChange_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TMap _map34 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
            struct.fileList = new HashMap<String,Boolean>(2*_map34.size);
            String _key35;
            boolean _val36;
            for (int _i37 = 0; _i37 < _map34.size; ++_i37)
            {
              ...
              struct.fileList.put(_key35, _val36);
            }
          }
          struct.setFileListIsSet(true);
        }
  ...
  public static class getPref_args implements org.apache.thrift.TBase<getPref_args, getPref_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPref_args>   {
    ...
    public GetPrefTOptions options; // required
  ...
  public static class getPref_result implements org.apache.thrift.TBase<getPref_result, getPref_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPref_result>   {
    ...
    public GetPrefTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class access_args implements org.apache.thrift.TBase<access_args, access_args._Fields>, java.io.Serializable, Cloneable, Comparable<access_args>   {
    ...
    public Map<String,Double> prefList; // required
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, access_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.prefList != null) {
          oprot.writeFieldBegin(PREF_LIST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter42 : struct.prefList.entrySet())
            {
        ...
        if (struct.isSetPrefList()) {
          {
            ...
            for (Map.Entry<String, Double> _iter43 : struct.prefList.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.prefList = new HashMap<String,Double>(2*_map44.size);
            String _key45;
            double _val46;
            for (int _i47 = 0; _i47 < _map44.size; ++_i47)
            {
              ...
              struct.prefList.put(_key45, _val46);
            }
          }
          struct.setPrefListIsSet(true);
        }
  ...
  public static class access_result implements org.apache.thrift.TBase<access_result, access_result._Fields>, java.io.Serializable, Cloneable, Comparable<access_result>   {
    ...
    public AccessTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
  ...
  public static class reset_args implements org.apache.thrift.TBase<reset_args, reset_args._Fields>, java.io.Serializable, Cloneable, Comparable<reset_args>   {
    ...
    public ResetTOptions options; // required
  ...
  public static class reset_result implements org.apache.thrift.TBase<reset_result, reset_result._Fields>, java.io.Serializable, Cloneable, Comparable<reset_result>   {
    ...
    public ResetTResponse success; // required
    public alluxio.thrift.AlluxioTException e; // required
