...
public class FileInfo implements org.apache.thrift.TBase<FileInfo, FileInfo._Fields>, java.io.Serializable, Cloneable, Comparable<FileInfo> {
  ...
  public boolean cacheable; // required
  ...
  public boolean mountPoint; // required
  public List<FileBlockInfo> fileBlockInfos; // required
  /**
   * 
   * @see alluxio.thrift.TTtlAction
   */
  public alluxio.thrift.TTtlAction ttlAction; // required
  public long mountId; // required
  public int inAlluxioPercentage; // required
  public String ufsFingerprint; // required
