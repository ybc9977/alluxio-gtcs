  ...
  public long getSpace(String path, SpaceType type) throws IOException {
    ...
    if (hdfs instanceof DistributedFileSystem) {
      ...
      switch (type) {
        case SPACE_TOTAL:
          //JCP! ifdef HADOOP1
//JCP>           space = ((DistributedFileSystem) hdfs).getDiskStatus().getCapacity();
          //JCP! else
        ...
        case SPACE_USED:
          //JCP! ifdef HADOOP1
//JCP>           space = ((DistributedFileSystem) hdfs).getDiskStatus().getDfsUsed();
          //JCP! else
        ...
        case SPACE_FREE:
          //JCP! ifdef HADOOP1
//JCP>           space = ((DistributedFileSystem) hdfs).getDiskStatus().getRemaining();
          //JCP! else
