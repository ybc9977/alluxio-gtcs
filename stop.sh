...
python3 ~/Downloads/flintrock-master/standalone.py run-command gtcs "rm -rf ~/alluxio-gtcs/logs ;rm -rf ~/alluxio-gtcs/underFSStorage/;mkdir ~/alluxio-gtcs/underFSStorage"
